...
FROM
    (
        SELECT
            ...
            "mailcode_0" AS "MAILCODE_0",
            "mailcode_1" AS "MAILCODE_1",
            "pvastate_0" AS "PVASTATE_0",
            "pvastate_1" AS "PVASTATE_1",
            "pvastate_2" AS "PVASTATE_2",
            "noexch_0" AS "NOEXCH_0",
            "noexch_1" AS "NOEXCH_1",
            "noexch_2" AS "NOEXCH_2",
            "noexch_3" AS "NOEXCH_3",
            "child18_0" AS "CHILD18_0",
            "child18_1" AS "CHILD18_1",
            "child18_2" AS "CHILD18_2",
            "child18_3" AS "CHILD18_3",
            "gender_0" AS "GENDER_0",
            "gender_1" AS "GENDER_1",
            "gender_2" AS "GENDER_2",
            "gender_3" AS "GENDER_3",
            "gender_4" AS "GENDER_4",
            "gender_5" AS "GENDER_5",
            "gender_6" AS "GENDER_6",
            "datasrce_0" AS "DATASRCE_0",
            "datasrce_1" AS "DATASRCE_1",
            "datasrce_2" AS "DATASRCE_2",
            "datasrce_3" AS "DATASRCE_3",
            "solp3_0" AS "SOLP3_0",
            "solp3_1" AS "SOLP3_1",
            "solp3_2" AS "SOLP3_2",
            "solp3_3" AS "SOLP3_3",
            ...
            "recinhse_0" AS "RECINHSE_0",
            "recinhse_1" AS "RECINHSE_1",
            "recp3_0" AS "RECP3_0",
            "recp3_1" AS "RECP3_1",
            "recpgvg_0" AS "RECPGVG_0",
            "recpgvg_1" AS "RECPGVG_1",
            "recsweep_0" AS "RECSWEEP_0",
            "recsweep_1" AS "RECSWEEP_1",
            ...
            "major_0" AS "MAJOR_0",
            "major_1" AS "MAJOR_1",
            "geocode_0" AS "GEOCODE_0",
            "geocode_1" AS "GEOCODE_1",
            "geocode_2" AS "GEOCODE_2",
            "geocode_3" AS "GEOCODE_3",
            "geocode_4" AS "GEOCODE_4",
            "geocode_5" AS "GEOCODE_5",
            "geocode_6" AS "GEOCODE_6",
            "geocode_7" AS "GEOCODE_7",
            "collect1_0" AS "COLLECT1_0",
            "collect1_1" AS "COLLECT1_1",
            "veterans_0" AS "VETERANS_0",
            "veterans_1" AS "VETERANS_1",
            "bible_0" AS "BIBLE_0",
            "bible_1" AS "BIBLE_1",
            "catlg_0" AS "CATLG_0",
            "catlg_1" AS "CATLG_1",
            ...
            "ageflag_0" AS "AGEFLAG_0",
            "ageflag_1" AS "AGEFLAG_1",
            "ageflag_2" AS "AGEFLAG_2",
            "homeownr_0" AS "HOMEOWNR_0",
            "homeownr_1" AS "HOMEOWNR_1",
            "homeownr_2" AS "HOMEOWNR_2",
            "child03_0" AS "CHILD03_0",
            "child03_1" AS "CHILD03_1",
            "child03_2" AS "CHILD03_2",
            "child03_3" AS "CHILD03_3",
            "child07_0" AS "CHILD07_0",
            "child07_1" AS "CHILD07_1",
            "child07_2" AS "CHILD07_2",
            "child07_3" AS "CHILD07_3",
            "child12_0" AS "CHILD12_0",
            "child12_1" AS "CHILD12_1",
            "child12_2" AS "CHILD12_2",
            "child12_3" AS "CHILD12_3",
            "homee_0" AS "HOMEE_0",
            "homee_1" AS "HOMEE_1",
            "pets_0" AS "PETS_0",
            "pets_1" AS "PETS_1",
            "cdplay_0" AS "CDPLAY_0",
            "cdplay_1" AS "CDPLAY_1",
            "stereo_0" AS "STEREO_0",
            "stereo_1" AS "STEREO_1",
            "pcowners_0" AS "PCOWNERS_0",
            "pcowners_1" AS "PCOWNERS_1",
            "photo_0" AS "PHOTO_0",
            "photo_1" AS "PHOTO_1",
            "mdmaud_r_0" AS "MDMAUD_R_0",
            "mdmaud_r_1" AS "MDMAUD_R_1",
            "mdmaud_r_2" AS "MDMAUD_R_2",
            "mdmaud_r_3" AS "MDMAUD_R_3",
            "mdmaud_r_4" AS "MDMAUD_R_4",
            "mdmaud_f_0" AS "MDMAUD_F_0",
            "mdmaud_f_1" AS "MDMAUD_F_1",
            "mdmaud_f_2" AS "MDMAUD_F_2",
            "mdmaud_f_3" AS "MDMAUD_F_3",
            "crafts_0" AS "CRAFTS_0",
            "crafts_1" AS "CRAFTS_1",
            "fisher_0" AS "FISHER_0",
            "fisher_1" AS "FISHER_1",
            "gardenin_0" AS "GARDENIN_0",
            "gardenin_1" AS "GARDENIN_1",
            "boats_0" AS "BOATS_0",
            "boats_1" AS "BOATS_1",
            "walker_0" AS "WALKER_0",
            "walker_1" AS "WALKER_1",
            "kidstuff_0" AS "KIDSTUFF_0",
            "kidstuff_1" AS "KIDSTUFF_1",
            "cards_0" AS "CARDS_0",
            "cards_1" AS "CARDS_1",
            "plates_0" AS "PLATES_0",
            "plates_1" AS "PLATES_1",
            "lifesrc_0" AS "LIFESRC_0",
            "lifesrc_1" AS "LIFESRC_1",
            "lifesrc_2" AS "LIFESRC_2",
            "lifesrc_3" AS "LIFESRC_3",
            "pepstrfl_0" AS "PEPSTRFL_0",
            "pepstrfl_1" AS "PEPSTRFL_1",
            "rfa_2_0" AS "RFA_2_0",
            "rfa_2_1" AS "RFA_2_1",
            "rfa_2_2" AS "RFA_2_2",
            "rfa_2_3" AS "RFA_2_3",
            ...
            "rfa_2a_0" AS "RFA_2A_0",
            "rfa_2a_1" AS "RFA_2A_1",
            "rfa_2a_2" AS "RFA_2A_2",
            "rfa_2a_3" AS "RFA_2A_3",
            "rfa_5_0" AS "RFA_5_0",
            "rfa_5_1" AS "RFA_5_1",
            "rfa_5_2" AS "RFA_5_2",
            "rfa_5_3" AS "RFA_5_3",
            ...
            "mdmaud_a_0" AS "MDMAUD_A_0",
            "mdmaud_a_1" AS "MDMAUD_A_1",
            "mdmaud_a_2" AS "MDMAUD_A_2",
            "mdmaud_a_3" AS "MDMAUD_A_3",
            "mdmaud_a_4" AS "MDMAUD_A_4",
            "geocode2_0" AS "GEOCODE2_0",
            "geocode2_1" AS "GEOCODE2_1",
            "geocode2_2" AS "GEOCODE2_2",
            "geocode2_3" AS "GEOCODE2_3",
            "geocode2_4" AS "GEOCODE2_4",
            "geocode2_5" AS "GEOCODE2_5",
        ...
        FROM
            ...
            left join state_expand on kdd."STATE" = state_expand."state"
            left join mailcode_expand on kdd."MAILCODE" = mailcode_expand."mailcode"
            left join pvastate_expand on kdd."PVASTATE" = pvastate_expand."pvastate"
            left join noexch_expand on kdd."NOEXCH" = noexch_expand."noexch"
            left join child18_expand on kdd."CHILD18" = child18_expand."child18"
            left join gender_expand on kdd."GENDER" = gender_expand."gender"
            left join datasrce_expand on kdd."DATASRCE" = datasrce_expand."datasrce"
            left join solp3_expand on kdd."SOLP3" = solp3_expand."solp3"
            left join solih_expand on kdd."SOLIH" = solih_expand."solih"
            left join rfa_20_expand on kdd."RFA_20" = rfa_20_expand."rfa_20"
            left join recinhse_expand on kdd."RECINHSE" = recinhse_expand."recinhse"
            left join recp3_expand on kdd."RECP3" = recp3_expand."recp3"
            left join recpgvg_expand on kdd."RECPGVG" = recpgvg_expand."recpgvg"
            left join recsweep_expand on kdd."RECSWEEP" = recsweep_expand."recsweep"
            left join mdmaud_expand on kdd."MDMAUD" = mdmaud_expand."mdmaud"
            left join domain_expand on kdd."DOMAIN" = domain_expand."domain"
            left join major_expand on kdd."MAJOR" = major_expand."major"
            left join geocode_expand on kdd."GEOCODE" = geocode_expand."geocode"
            left join collect1_expand on kdd."COLLECT1" = collect1_expand."collect1"
            left join veterans_expand on kdd."VETERANS" = veterans_expand."veterans"
            left join bible_expand on kdd."BIBLE" = bible_expand."bible"
            left join catlg_expand on kdd."CATLG" = catlg_expand."catlg"
            left join rfa_23_expand on kdd."RFA_23" = rfa_23_expand."rfa_23"
            left join rfa_24_expand on kdd."RFA_24" = rfa_24_expand."rfa_24"
            left join rfa_2r_expand on kdd."RFA_2R" = rfa_2r_expand."rfa_2r"
            left join cluster_expand on kdd."CLUSTER" = cluster_expand."cluster"
            left join ageflag_expand on kdd."AGEFLAG" = ageflag_expand."ageflag"
            left join homeownr_expand on kdd."HOMEOWNR" = homeownr_expand."homeownr"
            left join child03_expand on kdd."CHILD03" = child03_expand."child03"
            left join child07_expand on kdd."CHILD07" = child07_expand."child07"
            left join child12_expand on kdd."CHILD12" = child12_expand."child12"
            left join homee_expand on kdd."HOMEE" = homee_expand."homee"
            left join pets_expand on kdd."PETS" = pets_expand."pets"
            left join cdplay_expand on kdd."CDPLAY" = cdplay_expand."cdplay"
            left join stereo_expand on kdd."STEREO" = stereo_expand."stereo"
            left join pcowners_expand on kdd."PCOWNERS" = pcowners_expand."pcowners"
            left join photo_expand on kdd."PHOTO" = photo_expand."photo"
            left join mdmaud_r_expand on kdd."MDMAUD_R" = mdmaud_r_expand."mdmaud_r"
            left join mdmaud_f_expand on kdd."MDMAUD_F" = mdmaud_f_expand."mdmaud_f"
            left join crafts_expand on kdd."CRAFTS" = crafts_expand."crafts"
            left join fisher_expand on kdd."FISHER" = fisher_expand."fisher"
            left join gardenin_expand on kdd."GARDENIN" = gardenin_expand."gardenin"
            left join boats_expand on kdd."BOATS" = boats_expand."boats"
            left join walker_expand on kdd."WALKER" = walker_expand."walker"
            left join kidstuff_expand on kdd."KIDSTUFF" = kidstuff_expand."kidstuff"
            left join cards_expand on kdd."CARDS" = cards_expand."cards"
            left join plates_expand on kdd."PLATES" = plates_expand."plates"
            left join lifesrc_expand on kdd."LIFESRC" = lifesrc_expand."lifesrc"
            left join pepstrfl_expand on kdd."PEPSTRFL" = pepstrfl_expand."pepstrfl"
            left join rfa_2_expand on kdd."RFA_2" = rfa_2_expand."rfa_2"
            left join rfa_3_expand on kdd."RFA_3" = rfa_3_expand."rfa_3"
            left join rfa_4_expand on kdd."RFA_4" = rfa_4_expand."rfa_4"
            left join rfa_2a_expand on kdd."RFA_2A" = rfa_2a_expand."rfa_2a"
            left join rfa_5_expand on kdd."RFA_5" = rfa_5_expand."rfa_5"
            ...
            left join rfa_15_expand on kdd."RFA_15" = rfa_15_expand."rfa_15"
            left join mdmaud_a_expand on kdd."MDMAUD_A" = mdmaud_a_expand."mdmaud_a"
            left join geocode2_expand on kdd."GEOCODE2" = geocode2_expand."geocode2"
    ) AS data