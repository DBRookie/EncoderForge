    ...
    (
        ...
        FROM
            (
                ...
                FROM
                    ukair
                    left join merged_environment_type_zone_site_name_table on ukair."Environment_Type" = merged_environment_type_zone_site_name_table."environment_type"
                    AND ukair."Zone" = merged_environment_type_zone_site_name_table."zone"
                    AND ukair."Site_Name" = merged_environment_type_zone_site_name_table."site_name"
            ) AS data
    ) AS data