...
def set_JUST_PUSH_FLAG(flag):
    ...
    JUST_PUSH_FLAG = flag
SAMPLE_RATE = 1
PREPROCESS_PACKAGE_PATH = 'encoderforge.preprocess.'
MODEL_PACKAGE_PATH = 'encoderforge.model.'
...
class OperatorName(Enum):
    ...
    # Inter Merged Operator
    MERGEDENCODER = 'MergedEncoder'
...
ARRAY_JOIN_POSTNAME = '_array'
ARRAY_JOIN_COL_POSTNAME = '_array_list'
CON_C_CAT_JOIN_POSTNAME = "_mapping"
...
def in_cost_func_pg(length):
    ...
    #     return 1.7 * length
    if length <= 40:
        return 0.1589 * length + 1.7723
    elif length <= 80:
        return 0.1178 * length + 3.7142
    else:
        return 0.01356 * length + 13.958
...
rule_table_content = [
    ["uncertain", "uncertain", "uncertain", "disable",  "disable",   "disable",  "disable", "uncertain"],
    [    "apply",     "apply",     "apply",   "apply",    "apply", "uncertain",  "disable", "uncertain"],
    [    "apply",     "apply",     "apply",   "apply",    "apply", "uncertain",  "disable", "uncertain"],
    [    "apply",     "apply",     "apply",   "apply",    "apply",    "simply",   "simply", "uncertain"],
    [    "apply",     "apply",     "apply",   "apply",    "apply",    "simply",   "simply",   "disable"],
    [    "apply",     "apply",     "apply",   "apply",    "apply",   "disable",  "disable", "uncertain"],
    [    "apply",     "apply",     "apply",   "apply",    "apply",   "disable",  "disable",   "disable"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable"]
]

implementation_table_content = [
    [SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.JOIN,             None,             None,             None,             None, None],
    [SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.JOIN, SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.CASE,             None, None],
    [SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.CASE, SQLPlanType.JOIN, None],
    [SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.JOIN, SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.JOIN, None],
    [SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.CASE, SQLPlanType.JOIN, None],
    [SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.CASE, SQLPlanType.CASE,             None,             None, None],
    [SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN, SQLPlanType.JOIN,             None,             None, None],
...
rule_table_index_columns = [
    ...
    OperatorType.CON_C_CAT.value + SQLPlanType.JOIN.value,
...
fs_rule_table_content = [
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",     "apply", "disable",    "apply",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",     "apply", "disable",    "apply",   "disable",   "simply",   "disable",  "uncertain"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",     "apply", "disable",    "apply",   "disable",  "disable",   "disable",  "uncertain"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"],
    [  "disable",   "disable",   "disable", "disable",  "disable",   "disable",  "disable",   "disable",    "disable"]
]

fs_rule_table_index_columns = [
    OperatorType.CON_A_CON.value + SQLPlanType.CASE.value,
    OperatorType.CON_C_CAT.value + SQLPlanType.CASE.value,
    OperatorType.CON_C_CAT.value + SQLPlanType.JOIN.value,
    OperatorType.CAT_C_CAT.value + SQLPlanType.CASE.value,
...
fs_rule_table = DataFrame(
    fs_rule_table_content,
    index=fs_rule_table_index_columns,
    columns=fs_rule_table_index_columns
)

fs_implementation_table_content = [
    [            None,             None,             None,             None,             None,             None,             None, None, None],
    [            None,             None,             None,             None,             None,             None,             None, None, None],
    [            None,             None, SQLPlanType.JOIN,             None, SQLPlanType.JOIN,             None, SQLPlanType.JOIN, None, None],
    [            None,             None,             None,             None,             None,             None,             None, None, None],
    [            None,             None, SQLPlanType.JOIN,             None, SQLPlanType.JOIN,             None, SQLPlanType.JOIN, None, None],
    [            None,             None,             None,             None,             None,             None,             None, None, None],
    [            None,             None, SQLPlanType.JOIN,             None, SQLPlanType.JOIN,             None,             None, None, None],
    [            None,             None,             None,             None,             None,             None,             None, None, None],
    [            None,             None,             None,             None,             None,             None,             None, None, None]
]


fs_implementation_table = DataFrame(
    fs_implementation_table_content,
    index=fs_rule_table_index_columns,
    columns=fs_rule_table_index_columns
)

# whole map update every mergement
use_cut = False
...
single_op_sql_parent_dir = '/expr/sql/sqls_single_op/'